...
//        System.out.printf("Position: %s", position);
            ...
            signup.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent evt) {
                    ...
                    signupUserValidation.addActionListener(new ActionListener() {
                        @Override
                        public void actionPerformed(ActionEvent evt) {
                        	// Reset all text to null
                        	signupEmail.setText(null);
                        	signupPwd.setText(null);
                        	signupPwdValidation.setText(null);
            ...
            // Provide a signup form reference to the login form
    ...
    protected void setBackCommand(Form currentForm, Form backToForm) {
        ...
        back.setIcon(img);
        currentForm.getToolbar().addCommandToLeftBar(back);
        currentForm.getToolbar().setTitleCentered(true);
        currentForm.setBackCommand(back);
    }
